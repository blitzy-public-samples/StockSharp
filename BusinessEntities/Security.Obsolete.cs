...
public partial class Security
{
	...
	/// <see cref="Security"/> entity; instrument changes are now delivered as message-based, timestamped
	...
	/// <see cref="Level1Fields.StepPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.LastTrade"/> (together with <see cref="Level1Fields.LastTradePrice"/>,
	/// <see cref="Level1Fields.LastTradeVolume"/> and <see cref="Level1Fields.LastTradeTime"/>) carried
	/// inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.OpenPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.ClosePrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.LowPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.HighPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.BestBid"/> (together with <see cref="Level1Fields.BestBidPrice"/> and <see cref="Level1Fields.BestBidVolume"/>) carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.BestAsk"/> (together with <see cref="Level1Fields.BestAskPrice"/> and <see cref="Level1Fields.BestAskVolume"/>) carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.State"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.MinPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.MaxPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.MarginBuy"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.MarginSell"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.ImpliedVolatility"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.HistoricalVolatility"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.TheorPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Delta"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Gamma"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Vega"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Theta"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Rho"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.OpenInterest"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.BidsVolume"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.BidsCount"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.AsksVolume"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.AsksCount"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.TradesCount"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.HighBidPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.LowAskPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[XmlIgnore]
	[Display(
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Yield"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.VWAP"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.SettlementPrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.AveragePrice"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Volume"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <see cref="Security"/> entity; live market state is now delivered through the message pipeline as
	/// <see cref="Level1Fields.Turnover"/> carried inside a message-based, timestamped <see cref="Level1ChangeMessage"/>. Retained
	/// only for backward compatibility. Use <see cref="Level1ChangeMessage"/> instead.
	/// </remarks>
	[Display(
		ResourceType = typeof(LocalizedStrings),
